...
public class kayitGUI {
    ...
    public JButton getBtn1() {
        if (this.btn1 == null) {
            this.btn1 = new JButton("KAYIT OL");
            this.btn1.setBounds(600, 600, 100, 30);
            this.btn1.addActionListener(new kayitGUIAction(this));
    ...
    public JTextField getTxt1() {
        if (this.txt1 == null) {
            ...
            this.txt1.setBounds(300, 250, 200, 30);
    ...
    public JTextField getTxt2() {
        if (this.txt2 == null) {
            ...
            this.txt2.setBounds(300, 300, 200, 30);
    ...
    public JTextField getTxt3() {
        if (this.txt3 == null) {
            ...
            this.txt3.setBounds(300, 350, 200, 30);
    ...
    public JTextField getTxt4() {
        if (this.txt4 == null) {
            ...
            this.txt4.setBounds(300, 400, 200, 30);
    ...
    public JLabel getLbl1() {
        if (this.lbl1 == null) {
            this.lbl1 = new JLabel("AD");
            this.lbl1.setBounds(200, 250, 200, 30);
    ...
    public JLabel getLbl2() {
        if (this.lbl2 == null) {
            this.lbl2 = new JLabel("SOY AD");
            this.lbl2.setBounds(200, 300, 200, 30);
    ...
    public JLabel getLbl3() {
        if (this.lbl3 == null) {
            this.lbl3 = new JLabel("E-POSTA");
            this.lbl3.setBounds(200, 350, 200, 30);
    ...
    public JLabel getLbl4() {
        if (this.lbl4 == null) {
            this.lbl4 = new JLabel("SİFRE");
            this.lbl4.setBounds(200, 400, 200, 30);
            this.lbl4.setFont(new Font("Arial",Font.BOLD,13));
            this.lbl4.setForeground(Color.black);
    ...
    public ImageIcon getImageicon() {
        if(imageicon==null)
        {
            this.imageicon=new ImageIcon("C:\\Users\\User\\Documents\\NetBeansProjects\\TıyatroOtomasyonu\\gorsel\\charlie-chaplin-clown.jpg");
        }
        return imageicon;
    }
